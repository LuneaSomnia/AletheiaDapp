...
import { idlFactory } from './FactLedgerCanister.did.js';
export { idlFactory } from './FactLedgerCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FACTLEDGERCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./FactLedgerCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the FactLedgerCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./FactLedgerCanister.did.js")._SERVICE>}
 */
export const FactLedgerCanister = createActor(canisterId);
