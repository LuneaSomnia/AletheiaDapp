...
import { idlFactory } from './ClaimSubmissionCanister.did.js';
export { idlFactory } from './ClaimSubmissionCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CLAIMSUBMISSIONCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ClaimSubmissionCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ClaimSubmissionCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ClaimSubmissionCanister.did.js")._SERVICE>}
 */
export const ClaimSubmissionCanister = createActor(canisterId);
