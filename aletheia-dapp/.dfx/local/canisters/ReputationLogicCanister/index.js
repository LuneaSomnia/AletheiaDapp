...
import { idlFactory } from './ReputationLogicCanister.did.js';
export { idlFactory } from './ReputationLogicCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REPUTATIONLOGICCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./ReputationLogicCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the ReputationLogicCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./ReputationLogicCanister.did.js")._SERVICE>}
 */
export const ReputationLogicCanister = createActor(canisterId);
