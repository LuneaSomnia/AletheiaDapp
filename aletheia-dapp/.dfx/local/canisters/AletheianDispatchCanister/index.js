...
import { idlFactory } from './AletheianDispatchCanister.did.js';
export { idlFactory } from './AletheianDispatchCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ALETHEIANDISPATCHCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AletheianDispatchCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AletheianDispatchCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AletheianDispatchCanister.did.js")._SERVICE>}
 */
export const AletheianDispatchCanister = createActor(canisterId);
