...
import { idlFactory } from './EscalationCanister.did.js';
export { idlFactory } from './EscalationCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ESCALATIONCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./EscalationCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the EscalationCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./EscalationCanister.did.js")._SERVICE>}
 */
export const EscalationCanister = createActor(canisterId);
