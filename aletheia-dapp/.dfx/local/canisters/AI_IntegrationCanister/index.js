...
import { idlFactory } from './AI_IntegrationCanister.did.js';
export { idlFactory } from './AI_IntegrationCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_AI_INTEGRATIONCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AI_IntegrationCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AI_IntegrationCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AI_IntegrationCanister.did.js")._SERVICE>}
 */
export const AI_IntegrationCanister = createActor(canisterId);
