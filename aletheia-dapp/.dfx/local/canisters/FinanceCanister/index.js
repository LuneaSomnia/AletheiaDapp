...
import { idlFactory } from './FinanceCanister.did.js';
export { idlFactory } from './FinanceCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_FINANCECANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./FinanceCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the FinanceCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./FinanceCanister.did.js")._SERVICE>}
 */
export const FinanceCanister = createActor(canisterId);
