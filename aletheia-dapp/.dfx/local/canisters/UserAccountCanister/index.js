...
import { idlFactory } from './UserAccountCanister.did.js';
export { idlFactory } from './UserAccountCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_USERACCOUNTCANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./UserAccountCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the UserAccountCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./UserAccountCanister.did.js")._SERVICE>}
 */
export const UserAccountCanister = createActor(canisterId);
