...
import { idlFactory } from './AletheianProfileCanister.did.js';
export { idlFactory } from './AletheianProfileCanister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ALETHEIANPROFILECANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./AletheianProfileCanister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the AletheianProfileCanister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./AletheianProfileCanister.did.js")._SERVICE>}
 */
export const AletheianProfileCanister = createActor(canisterId);
